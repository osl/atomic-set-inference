...
PROJECT_NAME="jcurzez-aj2-Translated"
...
echo
echo ">>> Running..."
java -Djava.library.path=${PROJECT_PATH}/bin -cp ${jarFileName}:${WORKSPACE}/tracing/bin edu.illinois.cs.osl.aj.jcurzezFuzzer.FuzzEverything ${REPETITIONS} ${RANDOM_SEED}
echo "Done."
