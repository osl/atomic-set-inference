...
RESULTS_NAME="${PROJECT_NAME}-${RANDOM_SEED1}-${RANDOM_SEED2}-${REPETITIONS}"
...
echo
echo ">>> Running..."
java -cp ${jarFileName}:${WORKSPACE}/tracing/bin edu.illinois.cs.osl.aj.collectionsfuzzer.FuzzEverything ${REPETITIONS} ${RANDOM_SEED1} ${RANDOM_SEED2}
echo "Done."
